...
std::string current_add_button_index = "0";
...
void update_current_add_button(std::string &index) {
  current_add_button_index = index;
}


void add_description_computer(sf::RenderWindow &window, Button_Add &add_but,
